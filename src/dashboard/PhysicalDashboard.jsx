  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-bold flex items-center gap-2">📦 Physical Seller Dashboard</h2>
        <button 
      ...
      <div className="dashboard-grid">
        <div className={`dashboard-card glass ${isEditMode ? 'border-2 border-dashed border-indigo-300 relative cursor-pointer hover:bg-indigo-50' : ''}`}>
          ...
          <h4 className="text-secondary text-sm uppercase font-bold tracking-wider mb-2">Total Orders</h4>
        ...
        <div className={`dashboard-card glass ${isEditMode ? 'border-2 border-dashed border-indigo-300 relative cursor-pointer hover:bg-indigo-50' : ''}`}>
          ...
          <div className="text-3xl font-extrabold text-primary">$2,500</div>
        </div>
        <div className="dashboard-card glass">
          <h4 className="text-secondary text-sm uppercase font-bold tracking-wider mb-2">Stock Alerts</h4>
          <div className="text-3xl font-extrabold text-warning">3</div>
        </div>
      </div>

      <div className="mt-8">
        <h3 className="text-lg font-bold mb-4 border-b border-gray-100 pb-2">Recent Orders</h3>
        <ul className="space-y-3">
          <li className="flex justify-between items-center bg-gray-50 p-3 rounded-lg border border-gray-100">
            <span className="font-semibold">Order #123</span>
            <span className="status-badge badge-success">Shipped</span>
          </li>
          <li className="flex justify-between items-center bg-gray-50 p-3 rounded-lg border border-gray-100">
            <span className="font-semibold">Order #124</span>
            <span className="status-badge badge-warning">Pending</span>
          </li>
        </ul>
      </div>
    </div>
